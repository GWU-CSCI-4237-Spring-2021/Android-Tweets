...
class ExampleUnitTest {
    ...
    fun testSearchTweetsJsonParsing() {
        ...
        val jsonParser = SearchTweetsJsonParser()
        val parsedTweets = jsonParser.parseJson(exampleJson)

        assertTrue(parsedTweets.isNotEmpty())

        val firstTweets = parsedTweets[0]
        assertEquals("@LewisElrick Apple or Android? Cuz it ain’t working for me", firstTweets.content)
    }
}